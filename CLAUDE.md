...
**64 tools**, organized into 3 categories on `/tools`:
...
**📄 PDF Tools (31):** jpg-to-pdf, image-to-pdf, pdf-to-jpg, pdf-to-word, word-to-pdf, excel-to-pdf, powerpoint-to-pdf, merge-pdf, split-pdf, compress-pdf, rotate-pdf, pdf-page-organizer, add-page-numbers, edit-pdf-metadata, crop-pdf-pages, resize-pdf-pages, delete-pdf-pages, extract-pdf-text, ocr-pdf, fill-pdf-forms, pdf-editor, watermark-pdf, sign-pdf, html-to-pdf, flatten-pdf, text-to-pdf, add-stamps, compare-pdfs, pdf-color-filters, n-up-pdf, alternate-mix-pages

**🛠️ Utility Tools (13):** exif-remover, image-metadata-viewer, favicon-generator, qr-code-generator, image-to-base64, color-picker-from-image, image-dimension-checker, password-generator, uuid-generator, json-formatter, case-converter, word-character-counter, color-picker-converter
